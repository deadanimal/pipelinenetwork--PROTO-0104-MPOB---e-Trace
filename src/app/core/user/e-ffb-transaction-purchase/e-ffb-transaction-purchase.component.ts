...
@Component({
  selector: 'app-e-ffb-transaction-purchase',
  templateUrl: './e-ffb-transaction-purchase.component.html',
  styleUrls: ['./e-ffb-transaction-purchase.component.scss']
})
export class EFfbTransactionPurchaseComponent implements OnInit {
  chart: any
  ...
  getPieChart() {
    ...
    let chart = am4core.create("piechartdiv4", am4charts.PieChart);
  ...
  getBarChart() {
    ...
    let chart = am4core.create("barchartdiv4", am4charts.XYChart);
